...
public class CatalogueController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateCatalogueRequest request)
    {
    ...
    {
        PagedResult<CatalogueDto> result = await _service.ListAsync(page, pageSize);
        return Ok(result);
    }

    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, UpdateCatalogueRequest request)
    {
