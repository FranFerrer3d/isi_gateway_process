...
public class OrganizationTypeController : ControllerBase
{
    ...
    [HttpPost]
    public async Task<IActionResult> Create(CreateOrganizationTypeRequest request)
    {
    ...
    {
        PagedResult<OrganizationTypeDto> result = await _service.ListAsync(page, pageSize);
        return Ok(result);
    }

    [HttpPut("{id:guid}")]
    public async Task<IActionResult> Update(Guid id, UpdateOrganizationTypeRequest request)
    {
